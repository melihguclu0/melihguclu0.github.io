...
Şimdi Git'in **ksshaskpass** komutunu bulup çalıştırması için **GIT_ASKPASS** ortam değişkenini [environment variable](2024-11-24-environment_variables.md)  tanımlamamız gerekiyor.[^ref2]
