...
Şimdi Git'in **ksshaskpass** komutunu bulup çalıştırması için **GIT_ASKPASS** ortam değişkenini [environment variable](environment_variables.md) tanımlamamız gerekiyor.[^ref2]
