...
Şimdi Git'in **ksshaskpass** komutunu bulup çalıştırması için **GIT_ASKPASS** ortam değişkenini(environment variable)[a relative link](environment_variable.md) tanımlamamız gerekiyor.[^ref2]
